...
public class Road implements Comparable<Road> {
    ...
    private int priFirstChannelId;
    private int normalFirstChannelId;
    private int curFirstChannelId;
...
//          	
//          	if(c.getFlag()==Car.WAIT) {
//          		if(c.isProiority()==true)
//          			if(c.getCurRoadDis()>primaxDis) {
//              			primaxDis=c.getCurRoadDis();
//              			prires=c;
//              			priFirstChannelId = ch.cid;
//          		}
//          		else if(c.isProiority()==false) {
//          			if(c.getCurRoadDis()>maxDis){
//                        maxDis = c.getCurRoadDis();
//                        normres=c;
//                        normalFirstChannelId = ch.cid;
//                    }
//          		}
//          	}
//          }
//          if(primaxDis!=-1) {
//          	curFirstChannelId=priFirstChannelId;
//          	res=prires;
//          }
//          else {        
//          	curFirstChannelId=normalFirstChannelId;
//          	res=normres;
//          }
//      }
//  }else{
